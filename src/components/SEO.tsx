...
const SEO = ({
  ...
  const fullTitle = `${title} | Torque AI`;
  const canonicalUrl = url.startsWith('http') ? url : `https://torqueapp.ai${url}`;
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="Torque AI" />
      ...
      <meta name="twitter:creator" content="@chrisdessi" />
