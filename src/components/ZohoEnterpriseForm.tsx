...
declare global {
  interface Window {
    setupSF: (id: string, type: string, flag: boolean, acc: string, flag2: boolean, num: string) => void;
    referenceSetter: (el: HTMLImageElement) => void;
  }
}
  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      <style>{`
        ...
        #sf3zd785347fbb8bca06ba2d474323b850dcbb00db779284d8d8601a535c4bd30dfb .zcinputbox input {
          width: 100% !important;
        }
      `}</style>
          ...
          <div data-name="SIGNUP_PAGE" className="large_form_1_css" id="SIGNUP_PAGE" style={{ padding: '40px 30px 30px', backgroundColor: '#ffffff', fontFamily: 'Verdana', color: '#ffffff', textAlign: 'center', fontSize: '8px' }}>
            ...
            <div id="signupMainDiv" style={{ margin: '0px auto', width: '100%', minWidth: '230px', maxWidth: '600px' }}>
              <div>
                ...
                <form method="POST" id="zcampaignOptinForm" style={{ margin: '0px' }} action="https://idzlf-cmpzourl.maillist-manage.com/weboptin.zc" target="_zcSignup">
                      ...
                      <div style={{ margin: '0px auto', textAlign: 'left' }}>
                        ...
                        <div>
                          ...
                          <div style={{ padding: '10px', textAlign: 'center' }}>
                            <input type="button" id="zcWebOptin" name="SIGNUP_SUBMIT_BUTTON" style={{ cursor: 'pointer', appearance: 'none', borderRadius: '3px', outline: 'none', padding: '5px 15px', textAlign: 'center', color: 'rgb(255, 255, 255)', fontSize: '22px', backgroundColor: 'rgb(191, 0, 3)', border: 'none', fontFamily: 'Verdana', whiteSpace: 'normal' }} value="APPLY NOW" />
                          </div>
                        </div>
                      </div>
                    </div>
