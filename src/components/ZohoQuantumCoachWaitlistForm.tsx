...
declare global {
  interface Window {
    ...
    runOnFormSubmit_sf3zb23177f10bdcc7c4ce377eb708724af15d47769e6568ec3b3c9ebafa26dd6daa?: (th: any) => void;
  }
}
...
export const ZohoQuantumCoachWaitlistForm = () => {
  useEffect(() => {
    ...
    window.runOnFormSubmit_sf3zb23177f10bdcc7c4ce377eb708724af15d47769e6568ec3b3c9ebafa26dd6daa = function(th) {
    ...
    return () => {
      ...
      delete window.runOnFormSubmit_sf3zb23177f10bdcc7c4ce377eb708724af15d47769e6568ec3b3c9ebafa26dd6daa;
    };
  }, []);
  ...
  return (
    <div className="w-full">
      ...
      <div id="sf3zb23177f10bdcc7c4ce377eb708724af15d47769e6568ec3b3c9ebafa26dd6daa" data-type="signupform" style={{ opacity: 1 }}>
                ...
                <div id="Zc_SignupSuccess" style={{ display: 'none', position: 'absolute', marginLeft: '4%', width: '90%', backgroundColor: 'white', padding: '3px', border: '3px solid rgb(194, 225, 154)', marginTop: '10px', marginBottom: '10px', wordBreak: 'break-all' }}>
                  <table width="100%" cellPadding="0" cellSpacing="0" border={0}>
                    <tbody>
                      <tr>
                        <td width="10%">
                          <img className="successicon" src="https://idzlf-cmpzourl.maillist-manage.com/images/challangeiconenable.jpg" style={{ verticalAlign: 'middle' }} />
                        </td>
                        <td>
        ...
        <img src="https://idzlf-cmpzourl.maillist-manage.com/images/spacer.gif" id="refImage" style={{ display: 'none' }} />
      </div>
