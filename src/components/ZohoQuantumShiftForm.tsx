...
const ZohoQuantumShiftForm = () => {
  useEffect(() => {
    ...
    script.onload = () => {
      ...
      if (window.setupSF) {
        // @ts-ignore
        window.setupSF('sf3z3d70536b0878d0b828323880970032fb14170799e17ba46c4b5549c699ff8a5b','ZCFORMVIEW',false,'light',false,'0');
      }
    };
  ...
  return (
    <>
      ...
      <div id="sf3z3d70536b0878d0b828323880970032fb14170799e17ba46c4b5549c699ff8a5b" data-type="signupform" style={{ opacity: 1 }}>
        <div id="customForm">
          <div data-name="SIGNUP_BODY" style={{ width: '300px', height: '380px', position: 'relative', margin: 'auto', backgroundColor: 'rgb(255, 255, 255)', overflow: 'hidden' }}>
            ...
            <div style={{ width: '300px', height: '380px', position: 'relative', fontFamily: '"Arial"', margin: 'auto' }}>
              ...
              <form method="POST" id="zcampaignOptinForm" style={{ margin: '0px', width: '100%', color: 'rgb(255, 255, 255)' }} action="https://idzlf-zgpm.maillist-manage.com/weboptin.zc" target="_zcSignup">
                ...
                <input type="hidden" id="zc_formIx" name="zc_formIx" value="3z3d70536b0878d0b828323880970032fb14170799e17ba46c4b5549c699ff8a5b" />
