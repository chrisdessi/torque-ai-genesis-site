...
export const ZohoTorqueAIButton = () => {
  useEffect(() => {
    ...
    if (!document.querySelector('script[src*="optin.min.js"]')) {
  ...
  return (
    <div className="inline-block">
      <style dangerouslySetInnerHTML={{ __html: `
        .torque-ai-button-form .quick_form_7_css * { 
        ...
        @media only screen and (max-width: 600px) {
          .torque-ai-button-form .quick_form_7_css[data-name="SIGNUP_BODY"] { 
            width: 100% !important; 
            min-width: 100% !important; 
            margin: 0px auto !important; 
            padding: 0px !important 
          } 
          .torque-ai-button-form .SIGNUP_FLD { 
            width: 90% !important; 
            margin: 15px 5% !important; 
            padding: 0px !important 
          } 
          .torque-ai-button-form .SIGNUP_FLD input { 
            margin: 0 !important 
          } 
        }
      `}} />
      
      <div className="torque-ai-button-form">
