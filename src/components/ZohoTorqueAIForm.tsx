...
export const ZohoTorqueAIForm = () => {
  ...
  useEffect(() => {
    ...
    script.onload = () => {
      // Initialize Zoho form after script loads
      setTimeout(() => {
        ...
        if (formContainer) {
          ...
          if (submitBtn && form) {
            submitBtn.onclick = () => {
              ...
              const nameInput = formContainer.querySelector('[name="LASTNAME"]') as HTMLInputElement;
