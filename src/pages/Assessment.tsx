    ...
    <div className="min-h-screen bg-white">
      ...
      {!showResults ? (
                ...
                <div className="p-8 md:p-12">
                  <form onSubmit={handleSubmit} className="space-y-10">
                    ...
                    <div className="border-t border-slate-200 pt-10">
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-500 mt-2">Signals budget & appetite: "Done-for-you" implies highest investment.</p>
                        </div>
                      </div>
                      <div className="mt-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-center">
                      ...
                      <span className="text-sm text-slate-600">~3 minutes · Instant results</span>
                    </div>
                  </form>
                </div>
              </Card>
        ...
        <section className="bg-white py-16">
          <div className="section-padding max-w-5xl mx-auto">
            <motion.div {...fadeInUp}>
              <h2 className="text-4xl font-bold text-center mb-8">Your Results</h2>
              ...
              <Card className="bg-gradient-to-br from-blue-50 to-white border-2 border-blue-200 mb-8">
                <div className="p-8">
                  <h3 className="text-2xl font-bold text-slate-900 mb-4">Big Reveal</h3>
                  <p className="text-lg text-slate-700">{getReveal()}</p>
                </div>
              </Card>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                {getInsights().map((insight, i) => (
                  <Card key={i} className="border-2 border-slate-200">
                    <div className="p-6">
                      <h4 className="font-bold text-slate-900 mb-2">Insight #{i + 1}</h4>
              ...
              {/* Next Step */}
              <Card className="bg-gradient-to-br from-slate-50 to-white border-2 border-slate-200 mb-8">
                <div className="p-8">
                  <h3 className="text-2xl font-bold text-slate-900 mb-4">Recommended next step</h3>
                  <p className="text-lg text-slate-700 mb-6">{getNextStep()}</p>
              ...
              <Card className="border-2 border-slate-200">
                <div className="p-8">
                  <h3 className="text-3xl font-bold text-slate-900 mb-8 text-center">Work with Chris</h3>
                  <div className="grid md:grid-cols-3 gap-8">
                    <div>
                      <h4 className="text-xl font-bold text-slate-900 mb-3">90-Minute Diagnostic</h4>
                      <p className="text-sm text-slate-600 mb-4">Scorecard review, 90-day plan, weekly cadence template.</p>
                      <p className="text-2xl font-bold text-slate-900 mb-4">$1,500</p>
                      <p className="text-xs text-slate-500 mb-4">(creditable within 7 days)</p>
                      <Button 
                        variant="outline"
                        className="w-full"
                        onClick={() => window.open(MEETING_URL, '_blank')}
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-slate-900 mb-3">90-Day Operating Rhythm</h4>
                      <p className="text-sm text-slate-600 mb-4">Weekly commits, single scorecard, AI content+pipeline starter.</p>
                      <p className="text-2xl font-bold text-slate-900 mb-4">$9,000</p>
                      <p className="text-xs text-slate-500 mb-4">(or $3,000/mo)</p>
                      <Button 
                        variant="outline"
                        className="w-full"
                        onClick={() => window.open(MEETING_URL, '_blank')}
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-slate-900 mb-3">Done-for-You 30-Day Sprint</h4>
                      <p className="text-sm text-slate-600 mb-4">Publish engine, outreach sequences, CRM hygiene, leadership cadence.</p>
                      <p className="text-2xl font-bold text-slate-900 mb-4">$25,000</p>
