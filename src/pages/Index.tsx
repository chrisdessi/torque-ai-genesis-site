...
export default function Index() {
  return (
    <div className="min-h-screen bg-background text-foreground font-lexend">
      ...
      <section id="marketing-services" className="relative overflow-hidden bg-gradient-to-br from-background via-secondary/50 to-background">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_hsl(217_91%_60%_/_0.08)_0%,_transparent_50%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_hsl(280_70%_50%_/_0.05)_0%,_transparent_50%)]" />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-20 lg:py-28">
          ...
          >
            ...
            <motion.h1 
              variants={fadeInUp}
              className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-foreground leading-tight mb-6"
            >
            ...
            <motion.p 
              variants={fadeInUp}
              className="text-base sm:text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-8"
            >
              Beyond decision systems, Torque offers complete marketing agency services — from strategy and positioning to content creation and conversion optimization.
            </motion.p>
            <motion.a
              variants={fadeInUp}
          ...
          >
            {[
              { 
                ...
                description: "User personas, positioning, and acquisition channels that actually work",
                color: "from-blue-500 to-indigo-600"
              },
              { 
                icon: BarChart3, 
                title: "Market Analysis", 
                description: "Competitor research, customer journey mapping, and actionable insights",
                color: "from-purple-500 to-violet-600"
              },
              { 
                icon: TrendingUp, 
                title: "Conversion Optimization", 
                description: "Landing pages, pricing strategies, and email sequences that sell",
                color: "from-orange-500 to-red-600"
              },
              { 
                icon: PenTool, 
                title: "Content & SEO", 
                description: "High-quality blog articles, social posts, and keyword-optimized content",
                color: "from-emerald-500 to-teal-600"
              },
              { 
                icon: Megaphone, 
                title: "Paid Advertising", 
                description: "Profitable ad campaigns across Google, Meta, and LinkedIn",
                color: "from-pink-500 to-rose-600"
              },
              { 
                icon: Brain, 
                title: "AI-Powered Execution", 
                description: "Save hours on marketing tasks with our AI assistant and research tools",
              ...
              <motion.div
                ...
                className="group relative bg-card/80 backdrop-blur-sm border border-border rounded-2xl p-6 sm:p-8 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/10 transition-all duration-300"
              >
                <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br ${service.color} flex items-center justify-center shadow-lg mb-4 sm:mb-5`}>
          ...
          {/* Quiz CTA */}
          <motion.div 
            className="relative rounded-3xl border-2 border-primary/20 bg-gradient-to-br from-primary/5 via-secondary to-primary/5 p-8 sm:p-10 lg:p-12 text-center"
          ...
          >
            ...
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mt-4 mb-4">
              Not sure which services you need?
            </h3>
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Take our 2-minute quiz to get personalized recommendations based on your business goals, challenges, and growth stage.
            </p>
            <motion.a
              href="/marketing-agency-services#quiz"
              className="inline-flex items-center justify-center rounded-full border-2 border-primary bg-transparent px-8 py-4 text-lg font-bold text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              Take the Quiz
