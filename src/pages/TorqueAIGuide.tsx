...
import { ArrowRight, Sparkles, Rocket, Brain, LineChart, Users, Gauge, CheckCircle2, BookOpen, Download } from "lucide-react";
 ...
 * Aesthetic: sleek SaaS (black/white + deep violet accents)
 *
 * Usage:
 * - Drop this file into your Lovable project (e.g., app/torque-ai-guide.tsx)
 * - Ensure Tailwind + shadcn are configured
 * - Add to header & footer nav as "AI Strategy Guide"
 */
...
export default function TorqueAIGuide() {
  return (
    <>
      <Header />
      <div className="min-h-screen bg-black text-white pt-16">
        ...
        <section className="relative border-t border-white/10 bg-gradient-to-b from-black to-[#120016]">
          <div className="mx-auto max-w-5xl px-6 py-16">
            <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-100px" }}>
              ...
              <motion.blockquote variants={item} className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-6 text-xl italic text-white/90">
        ...
        <section className="relative">
          <div className="mx-auto max-w-6xl px-6 py-16">
            <div className="grid gap-6 md:grid-cols-4">
              {[
                { icon: <Gauge className="h-5 w-5" />, title: "Discover", copy: "Audit teams to surface friction and high-impact AI use cases." },
                { icon: <Rocket className="h-5 w-5" />, title: "Deploy", copy: "Prototype in weeks. Ship secure, compliant, repeatable workflows." },
                { icon: <Brain className="h-5 w-5" />, title: "Train", copy: "Turn fear into fluency with role-based AI workshops and playbooks." },
                { icon: <LineChart className="h-5 w-5" />, title: "Track", copy: "Measure time saved, revenue gained, and adoption—then iterate." },
              ].map((c, i) => (
        ...
        <section className="relative">
          <div className="mx-auto max-w-6xl px-6 py-20">
            <div className="grid items-start gap-8 md:grid-cols-2">
              ...
              <Card className="border-white/10 bg-white/5">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-white"><Rocket className="h-5 w-5"/>Deployment Checklist</CardTitle>
                </CardHeader>
                <CardContent className="text-white/70">
        ...
        <section className="relative border-t border-white/10 bg-[#0A0011]">
          <div className="mx-auto max-w-6xl px-6 py-20">
            <div className="grid items-start gap-8 md:grid-cols-2">
              ...
              <Card className="border-white/10 bg-white/5">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-white"><BookOpen className="h-5 w-5"/>Workshop Formats</CardTitle>
                </CardHeader>
                <CardContent className="text-white/70">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    {[
                      ...
                      <div key={i} className="rounded-xl border border-white/10 bg-white/5 p-3">{x}</div>
                    ))}
                  </div>
                </CardContent>
              </Card>
        ...
        {/* CTA */}
        <section className="relative border-t border-white/10 bg-gradient-to-b from-[#0F0017] to-black">
          <div className="mx-auto max-w-6xl px-6 py-20">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-10 text-center">
              ...
              <p className="mt-6 text-sm text-white/50">© {new Date().getFullYear()} Torque AI. All rights reserved.</p>
            </div>
          </div>
        </section>
      </div>
